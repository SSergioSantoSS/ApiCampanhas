...
using ProjLg.Services.Api.Helpers;
using ProjLg.Services.Api.Security;
...
var connectionString = builder.Configuration.GetConnectionString("BD_CAMPLg");
...
//exportando todo o código como uma classe denominada Program.cs
